...
//		if (isset($results[0]))
	...
	//lista com todos os usuarios da tabela
...
//inserir 
	...
	public function update($login, $password){
		...
		$sql->query("UPDATE tb_usuarios SET deslogin=:LOGIN, dessenhar=:PASSWORD WHERE idusuario = :ID", array(	
			':LOGIN'=>$this->getDeslogin(), ':PASSWORD'=>$this->getDessenha(),':ID'=>$this->getIdusuario()
		));
	}
//a aplicação no metodo construtor a aspas duplas evita da erro e preenche com vazio
